        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-semibold mb-4"> - Crea Seduta personale</h1>
                    ...
                    <form method="POST" action="{{ route('single_events.store')}}" class="space-y-4">
                        ...
                        <select  name="user" id="user" onchange="console.log(this.selectedOptions)"  class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
